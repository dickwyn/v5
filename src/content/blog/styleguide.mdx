...
description: 'Visual reference for blog typography, lists, code, tables, and embeds.'
slug: 'styleguide'
draft: true
---

> adapted from https://www.bryanbraun.com/poor-mans-styleguide/
...
# Embeds (Tina Templates)

<Tweet id="477369125224734720" height={260} />

<Iframe src="https://codesandbox.io/embed/new?codemirror=1" title="Sandbox" height={500} />

<YouTube id="fUJxQy7AlXI" />

<Figure src="/images/20200128_160155.png" alt="Sample image" caption="Figure caption" />
