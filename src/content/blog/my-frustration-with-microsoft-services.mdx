...
description: 'A few issues that I have encountered while using applications and/or services from Microsoft'
slug: 'my-frustration-with-microsoft-services'
draft: false
---
...
<Tweet id="1191477590323650560" height={945} />
...
<Figure
  ...
  caption="A screenshot of the Mac version of Microsoft Outlook. Highlighted on the bottom left is the sidebar with the Notes and Tasks tab."
/>
...
<Figure
  ...
  alt="Microsoft Outlook Mac sidebar screenshot"
  caption="The sticky note I created on the OneNote android app that could not sync with the changes made from the Microsoft Outlook notes tab"
/>
