...
timestamp: '2019-12-29T01:46:29.791Z'
featuredPost: false
featuredImage: office.com-screenshot-apps.png
tagList: ['microsoft', 'setup', 'rant']
---
...
```
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Dear <a href="https://twitter.com/Microsoft?ref_src=twsrc%5Etfw">@Microsoft</a>, <br><br>Cc <a href="https://twitter.com/Outlook?ref_src=twsrc%5Etfw">@Outlook</a><br><br>If you can make Cortana read (Play My Emails) emails. I&#39;m sure you can build a better spam/junk filter.<br><br>Thanks, <a href="https://twitter.com/dickwyn?ref_src=twsrc%5Etfw">@dickwyn</a> <a href="https://t.co/S8uGdbuRCB">pic.twitter.com/S8uGdbuRCB</a></p>&mdash; Dick Wyn Yong (@dickwyn) <a href="https://twitter.com/dickwyn/status/1191477590323650560?ref_src=twsrc%5Etfw">November 4, 2019</a></blockquote>
```
...
<Image
    fileName="microsoft-outlook-sidebar-screenshot-mac.png"
    alt="Microsoft Outlook Mac sidebar screenshot"
    caption="A screenshot of the Mac version of Microsoft Outlook. Highlighted on the bottom left is the
    sidebar with the Notes and Tasks tab."
/>
...
<Image
    fileName="microsoft-outlook-mac-notes-tab.png"
    alt="Microsoft Outlook Mac sidebar screenshot"
    caption="The sticky note that was synced to the Microsoft Outlook notes tab"
/>
<Image
    fileName="microsoft-onenote-android-sticky-notes-tab.png"
    alt="Microsoft Outlook android stick notes tab screenshot"
    caption="The sticky note I created on the OneNote android app that could not sync with the changes made
    from the Microsoft Outlook notes tab"
/>
