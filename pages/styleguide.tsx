  ...
  divs[i].style.color = "green";
        ...
        <fieldset>
          ...
          <form>
            ...
            <p>
              <label htmlFor="text-field-disabled">Disabled Text Field:</label>
              <br />
              <input type="text" id="text-field-disabled" disabled value="I'm disabled" />
            </p>
            <p>
              <label htmlFor="text-field-readonly">Readonly Text Field:</label>
              <br />
            ...
            <p>
              <label htmlFor="text-area-disabled">Disabled Text Area:</label>
              <br />
            ...
            <p>
              <label htmlFor="text-area-readonly">Readonly Text Area:</label>
              <br />
            ...
            <p>
              <label htmlFor="select-element">Select Element:</label>
              <br />
            ...
            <p>
              <label htmlFor="select-element-disabled">Disabled Select Element:</label>
              <br />
            ...
            <div>
              ...
              <label htmlFor="radio-4">Radio Disabled</label>
            </div>
            <p>Checkboxes:</p>
            <div>
            ...
            <div>
              ...
              <label htmlFor="checkbox-4">Checkbox Disabled</label>
            </div>
            <p>
            ...
            <p>
              ...
              <br />
              <progress id="progress" value="65" max="100" />
            </p>
            <p>
            ...
            <p>
              <button className="button">Button Element</button>
