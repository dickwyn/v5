                ...
                list: [
                    {
                        ...
                        attributeList: [
                            { name: "This drive mirrors the files on my MacBook Pro's SSD." },
                        ],
                    },
...
const ItemList = ({ items, parentIndex }: any) => (
    <ul>
        {items.map(
            (
                item: {
        ...
        <Layout title="Uses">
            ...
            <div className="wrapper">
                <div className="content-container with-padding">
                    <p>
                        From casual web browsing to creating content for YouTube, here&apos;s a
                        comprehensive list of hardware and software that I use on a daily basis to
                    ...
                    {uses.map((section, sectionIndex) => (
                        <Fragment key={`section${sectionIndex}`}>
                            ...
                            {section.itemList && (
                                <ItemList
                                    items={
                                        section.sort ? sortList(section.itemList) : section.itemList
                                    }
                                    parentIndex={sectionIndex}
                                />
                            )}
